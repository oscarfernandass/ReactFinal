        ...
        <>
            <div className='out'>
                ...
                <div className='in'>
                    ...
                    <button>
                        <div className='cit' onClick={press} style={{ backgroundImage: `url('https://lp-cms-production.imgix.net/image_browser/GettyImages-624091590.jpg?auto=format&fit=crop&q=40&sharp=10&vib=20&ixlib=react-8.6.4')` }}
